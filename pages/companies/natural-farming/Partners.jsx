        ...
        <div className="font-sans antialiased text-gray-800 bg-white min-h-screen flex flex-col">
            ...
            <main className="flex-grow container mx-auto px-6 lg:px-12 py-12">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-4xl font-serif text-green-800 mb-6">Our Partners</h1>
                    <p className="text-lg text-gray-600 mb-8">
                        Collaborating with industry leaders to bring sustainable farming solutions to everyone.
                    </p>
                    <div className="p-12 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                        <p className="text-gray-500 italic">Partners content coming soon...</p>
                    </div>
                </div>
            </main>
            <NFFooter />
