...
const StatBarGreen = () => {
    ...
    return (
        <section ref={sectionRef} className="relative py-12 w-full bg-gray-900 overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {stats.map((stat, i) => (
                        <div
                            key={i}
                            className={`group relative bg-gray-800/40 backdrop-blur-md border border-[#00c853]/20 hover:border-[#00c853]/60 rounded-xl p-5 transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(0,200,83,0.2)] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <Activity size={16} className="text-gray-500 group-hover:text-[#00c853] animate-pulse" />
                            </div>

                            <div className="text-3xl lg:text-4xl font-mono font-bold text-white mb-1 tracking-tighter group-hover:text-[#00c853] transition-colors">
                                {stat.text ? (
                                    <span>{stat.text}</span>
                                ) : (
                            ...
                            <div className="text-[10px] lg:text-xs font-medium text-gray-400 uppercase tracking-widest mb-4">
                                {stat.label}
                            </div>
