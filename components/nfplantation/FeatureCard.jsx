...
const FeatureCard = ({ icon: Icon, title, desc, center = true }) => {
    return (
        <div className={`bg-gray-900/40 backdrop-blur-md rounded-xl p-8 border border-white/5 shadow-lg hover:shadow-[0_0_20px_rgba(16,185,129,0.1)] hover:border-emerald-500/30 transition-all duration-300 ${center ? 'text-center' : ''} h-full group`}>
            ...
            <h3 className="text-white font-bold mb-3 group-hover:text-emerald-400 transition-colors">{title}</h3>
